...
export default function TitleBarWindows() {
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="inline-flex items-center h-7 w-12 px-2.5 py-1.5 pb-1 border hover:text-white border-transparent text-xs font-medium shadow-sm text-white hover:bg-red-500 titleButtons dark:text-dark-white"
